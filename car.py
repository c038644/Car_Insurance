...
if Selector == 'Database Search':
    ...
    st.(page_title='Car Insurance Fraud Database Search',  layout='wide', page_icon=':Calculator:')
    ...
    st.(page_title='Car Insurance Policy Quote',  layout='wide', page_icon=':Calculator:')
