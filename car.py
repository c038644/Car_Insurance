...
if Selector == 'Database Search':
    ...
    t1.title(page_title='Car Insurance Fraud Database Search',  layout='wide', page_icon=':Calculator:')
    ...
    t1.title(page_title='Car Insurance Policy Quote',  layout='wide', page_icon=':Calculator:')
